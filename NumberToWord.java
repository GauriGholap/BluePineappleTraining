...
{ 
  ...
  {
    String[] units = {"Thousand", "Million", "Billion", "Trillion", "Quardrillion", "Sextillion", "Septillion", "Octillion", "Nonillion", "Decillion", "Undeillion", "Duodecillion", " Tredecillion", "Quatturordecillion", "Quindecillion", "Sexdecillion", "Septendecillion", "Octodecillion", "Novemdecillion", "Vigintillion"};
    String numWord = "";
    int count = 0;
    int len = str.length();
    int i = 0;
...
\JavaPro>Java NumberToWord
 ...
 Enter any number : 987654700000000000000000000000000000000000000000000000000000
000
Count of Digits : 63
Number in word is
 Nine Hundred Eighty Seven Vigintillion Six Hundred Fifty Four Novemdecillion Se
ven Hundred   Octodecillion
*/